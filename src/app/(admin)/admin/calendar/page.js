...
export default function AdminCalendarPage() {
  ...
  return (
    <div className="dashboard-page-container flex flex-col gap-6">
      {/* Page Header */}
      <header className="flex justify-between items-center gap-6 pb-6 border-b border-slate-200/60 mb-2">
        <div>
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3">
            <span className="p-2 bg-indigo-50 text-indigo-600 rounded-lg shadow-sm">📅</span> 
            Admin Calendar
          </h1>
          <p className="text-sm font-medium text-slate-400 mt-1">Manage bookings, block dates, and view analytics seamlessly.</p>
        </div>
